...
(let* ((bg "#18120b")
      ...
      (on-primary "#442b00")
      (on-primary-container "#ffddb2")
      (on-secondary "#3e2e16")
      (on-secondary-container "#fadebc")
      (on-surface "#ede0d4")
      (on-surface-variant "#d3c4b4")
      (on-tertiary "#243516")
      (on-tertiary-container "#d3eabc")
      (outline-color "#9b8f80")
      (outline-variant "#4f4539")
      (primary "#f3bd6e")
      (primary-container "#624000")
      (secondary "#ddc2a1")
      (secondary-container "#56442a")
      (shadow "#000000")
      (surface "#18120b")
      ...
      (tertiary "#b7cea2")
      (tertiary-container "#3a4c2a")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#b7cea2")
      (on-success "#243516")
      (success-container "#3a4c2a")
      (on-success-container "#d3eabc")
      ;; Map fixed colors to regular colors
      (primary-fixed "#f3bd6e")
      (primary-fixed-dim "#624000")
      (secondary-fixed "#ddc2a1")
      (secondary-fixed-dim "#56442a")
      (tertiary-fixed "#b7cea2")
      (tertiary-fixed-dim "#3a4c2a")
      (on-primary-fixed "#442b00")
      (on-primary-fixed-variant "#ffddb2")
      (on-secondary-fixed "#3e2e16")
      (on-secondary-fixed-variant "#fadebc")
      (on-tertiary-fixed "#243516")
      (on-tertiary-fixed-variant "#d3eabc")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#ede0d4")
      (inverse-primary "#f3bd6e")
      (inverse-surface "#18120b")
